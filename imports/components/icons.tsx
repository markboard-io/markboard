...
export const TextAlignTopIcon = React.memo(({ theme: _ }: { theme: Theme }) =>
  createIcon(
    <g
      strokeWidth='1.5'
      stroke='currentColor'
...
export const TextAlignBottomIcon = React.memo(({ theme: _ }: { theme: Theme }) =>
  createIcon(
    <g
      strokeWidth='2'
      stroke='currentColor'
...
export const TextAlignMiddleIcon = React.memo(({ theme: _ }: { theme: Theme }) =>
  createIcon(
    <g
      strokeWidth='1.5'
      stroke='currentColor'
...
export const MoreIcon = (
  ...
  >
    <g fill='currentColor'>
      <g>
        <path d='M8 3.5C7.17157 3.5 6.5 2.82843 6.5 2C6.5 1.17157 7.17157 0.5 8 0.5C8.82843 0.5 9.5 1.17157 9.5 2C9.5 2.82843 8.82843 3.5 8 3.5Z'></path>
        <path d='M8 9.5C7.17157 9.5 6.5 8.82843 6.5 8C6.5 7.17157 7.17157 6.5 8 6.5C8.82843 6.5 9.5 7.17157 9.5 8C9.5 8.82843 8.82843 9.5 8 9.5Z'></path>
        <path d='M8 15.5C7.17157 15.5 6.5 14.8284 6.5 14C6.5 13.1716 7.17157 12.5 8 12.5C8.82843 12.5 9.5 13.1716 9.5 14C9.5 14.8284 8.82843 15.5 8 15.5Z'></path>
      </g>
    </g>
  </svg>
)
  ...
  >
    <g fill='currentColor'>
      <g>
        ...
        ></path>
        <path d='M3.22701 12.773C5.86305 15.409 10.1369 15.409 12.773 12.773L3.22701 3.22703C0.590972 5.86307 0.590972 10.1369 3.22701 12.773Z'></path>
      </g>
    </g>
  </svg>
)

export const SimpleTrashIcon = (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    viewBox='0 0 16 16'
    width='16'
  ...
  >
    <g fill='currentColor'>
      <path
        fillRule='evenodd'
        clipRule='evenodd'
        d='M4.75 0.5C4.33579 0.5 4 0.835786 4 1.25C4 1.66421 4.33579 2 4.75 2H11.25C11.6642 2 12 1.66421 12 1.25C12 0.835786 11.6642 0.5 11.25 0.5H4.75ZM0.5 4.75C0.5 4.33579 0.835786 4 1.25 4H14.75C15.1642 4 15.5 4.33579 15.5 4.75C15.5 5.16421 15.1642 5.5 14.75 5.5H13.3901L11.8748 14.025C11.7396 14.8746 11.0069 15.5 10.1465 15.5H5.85351C4.99315 15.5 4.26042 14.8746 4.12524 14.025L2.60991 5.5H1.25C0.835786 5.5 0.5 5.16421 0.5 4.75ZM4.12877 5.5H11.8713L10.3934 13.7893C10.3741 13.9107 10.2694 14 10.1465 14H8.00002H5.85351C5.7306 14 5.62592 13.9107 5.60661 13.7893L4.12877 5.5Z'
      ></path>
    </g>
  </svg>
)
...
export const AddIcon = (
  <svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24'>
    <path
      fill='#BCB3B3'
      d='M12 18.634c.533 0 .976-.452.976-.944v-4.716h4.602a.98.98 0 00.96-.977.979.979 0 00-.96-.968h-4.602V6.313c0-.517-.443-.952-.976-.952a.972.972 0 00-.968.952v4.716h-4.61a.99.99 0 00-.96.968c0 .534.46.977.96.977h4.61v4.716c0 .492.443.944.968.944z'
    ></path>
  </svg>
)
