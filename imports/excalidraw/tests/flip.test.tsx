...
it('flips an unrotated arrow horizontally correctly', () => {
  ...
  // Check if width and height did not change
  expect(API.getSelectedElements()[0].width).toBeCloseTo(originalWidth, FLIP_PRECISION_DECIMALS)

  expect(API.getSelectedElements()[0].height).toBeCloseTo(originalHeight, FLIP_PRECISION_DECIMALS)
})
...
it('flips a rotated drawing vertically correctly', () => {
  ...
  expect(API.getSelectedElement().width).toBeCloseTo(originalWidth, FLIP_PRECISION_DECIMALS)

  expect(API.getSelectedElement().height).toBeCloseTo(originalHeight, FLIP_PRECISION_DECIMALS)
