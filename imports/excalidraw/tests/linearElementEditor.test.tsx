...
describe('Test Linear Elements', () => {
  ...
  describe('Test bound text element', () => {
    ...
    it('should not rotate the bound text and update position of bound text and bounding box correctly when arrow rotated', () => {
      ...
      expect(getBoundTextElementPosition(arrow, textElement)).toMatchInlineSnapshot(`
        Object {
          "x": 75,
          "y": 60,
        }
    ...
    it('should wrap the bound text when arrow bound container moves', async () => {
      ...
      expect(wrapText(textElement.originalText, font, getMaxContainerWidth(arrow)))
        .toMatchInlineSnapshot(`
        "Online whiteboard collaboration
        made easy"
      `)
      const handleBindTextResizeSpy = jest.spyOn(textElementUtils, 'handleBindTextResize')
