...
export const textWysiwyg = ({
  ...
  const updateWysiwygStyle = () => {
    ...
    const approxLineHeight = getApproxLineHeight(getFontString(updatedTextElement))
      ...
      if (container && updatedTextElement.containerId) {
        ...
        // is reached
          ...
          if (verticalAlign === VERTICAL_ALIGN.MIDDLE) {
            if (!isArrowElement(container)) {
              coordY = container.y + containerDims.height / 2 - textElementHeight / 2
            }
          }
  ...
  if (onChange) {
    ...
    editable.oninput = () => {
      const updatedTextElement = Scene.getScene(element)?.getElement(id) as ExcalidrawTextElement
      ...
      const lines = Math.round(editable.scrollHeight / getApproxLineHeight(font))
