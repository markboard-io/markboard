...
describe('textWysiwyg', () => {
  ...
  describe('Test container-bound text', () => {
    ...
    beforeAll(() => {
      jest.spyOn(textElementUtils, 'getApproxLineHeight').mockReturnValue(APPROX_LINE_HEIGHT)
    })
    ...
    it('should wrap text and vertcially center align once text submitted', async () => {
      jest.spyOn(textElementUtils, 'measureText').mockImplementation((text, font, maxWidth) => {
      ...
      // mock scroll height
      jest.spyOn(editor, 'scrollHeight', 'get').mockImplementation(() => APPROX_LINE_HEIGHT * 2)
      ...
      expect(text.y).toBe(rectangle.y + rectangle.height / 2 - (APPROX_LINE_HEIGHT * 2) / 2)
      ...
      // mock scroll height
      jest.spyOn(editor, 'scrollHeight', 'get').mockImplementation(() => APPROX_LINE_HEIGHT)
      ...
      expect(text.y).toBe(rectangle.y + rectangle.height / 2 - APPROX_LINE_HEIGHT / 2)
      expect(text.x).toBe(rectangle.x + BOUND_TEXT_PADDING)
