...
import { collabDialogShownAtom } from '../app/collab/Collab'
...
const WelcomeScreenItem = ({
  ...
  if (link) {
    return (
      <a className='WelcomeScreen-item' href={link} target='_blank' rel='noreferrer'>
  ...
  return (
    <button className='WelcomeScreen-item' type='button' onClick={onClick}>
      ...
      {shortcut && <div className='WelcomeScreen-item__shortcut'>{shortcut}</div>}
    </button>
  )
}
...
const WelcomeScreen = ({
  ...
  return (
    <div className='WelcomeScreen-container'>
      <div className='WelcomeScreen-logo virgil WelcomeScreen-decor'>{ExcalLogo} Excalidraw</div>
