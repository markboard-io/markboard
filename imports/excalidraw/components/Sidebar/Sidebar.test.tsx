...
import { Excalidraw, Sidebar } from '../../app/ExcalidrawBase'
import {
  act,
  fireEvent,
  queryAllByTestId,
  ...
  it('should render custom sidebar with dock (irrespective of onDock prop)', async () => {
    const CustomExcalidraw = () => {
      return (
        <Excalidraw
          initialData={{ appState: { openSidebar: 'customSidebar' } }}
          renderSidebar={() => <Sidebar className='test-sidebar'>hello</Sidebar>}
        />
      )
    }
    ...
    const CustomExcalidraw = () => {
      ...
      return (
        <Excalidraw
          initialData={{ appState: { openSidebar: 'customSidebar' } }}
          renderSidebar={() => (
            <Sidebar className='test-sidebar' docked={false} dockable={dockable}>
              hello
            </Sidebar>
          )}
        />
